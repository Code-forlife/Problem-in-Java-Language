...
public class Shop_Bill{
    public static void main(String[] args) {
        ...
        while(w.clothes != 0 || w.accessories != 0){
            ...
            System.out.print("Enter no. of clothes u wish to buy: ");
            int n = sc.nextInt();
            System.out.print("Enter no. of accessories u wish to buy: ");
            int m = sc.nextInt();
            int amount = ((n+m)*(5000));
            if(card[index].card_balance()>=amount || cash[index].cash_balance()>=amount) {
                w.reduce_accessories(m);
                w.reduce_clothes(n);
                System.out.printf("Total amount to be paid: $%d\n" , amount);
                System.out.print("Press 2 to pay in cash or press 1 to pay using credit card: ");
                ...
                else if (option == 2 && cash[index].cash_balance()>=amount) {
