...
class sales{
    ...
    void getdata(){
        System.out.print("Enter the dollar sales of the last three months.");
        for(int i = 0 ; i< 3;i++)
...
class book extends publication{
    ...
    price= sc.nextInt();
    System.out.print("Enter no. of pages the book contains: ");
    page= sc.nextInt();
    ...
    void putdata(){
        System.out.println(name +"\t"+ price + "\t"+ page +"\t"+sales[0]+"\t"+sales[1]+"\t"+sales[2]+"\t");
    }
}
class tape extends publication{
    int time;
    void getdata(){
    System.out.print("Enter name of tape: ");
    name = sc.nextLine();
    System.out.print("Enter price of "+name+": ");
    price= sc.nextInt();
    System.out.print("Enter playing time of "+name+" in minutes: ");
    time = sc.nextInt();
    System.out.print("Enter the dollar sales of the last three months.");
    for(int i = 0 ; i< 3;i++)
        sales[i]= sc.nextFloat();
    ...
    void putdata(){
        System.out.println(name +"\t"+ price + "\t"+ time+"\t"+sales[0]+"\t"+sales[1]+"\t"+sales[2]+"\t");
    }
}
